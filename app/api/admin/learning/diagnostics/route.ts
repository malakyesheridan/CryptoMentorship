...
export async function GET() {
  ...
  try {
    const recentUploads = await withDbRetry(
      () =>
      ...
      { mode: 'read', operationName: 'learning_upload_diagnostics' }
    )
    ...
    return toPrismaRouteErrorResponse(error, 'Failed to load learning diagnostics.')
  }
}
