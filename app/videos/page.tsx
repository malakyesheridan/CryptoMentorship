  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-[var(--text-muted)]">Browse our collection of video lessons and content</p>
      </div>
        ...
        <Card className="card">
          <CardContent className="py-12">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-[var(--text-strong)] mb-2">No videos available</h3>
              <p className="text-[var(--text-muted)]">Check back later for new video content</p>
            </div>
          </CardContent>
        </Card>
      ) : (
            ...
            <Link key={video.id} href={`/videos/${video.id}`}>
              <Card className="card hover:shadow-lg transition-shadow cursor-pointer">
                ...
                <CardContent className="p-4">
                  ...
                  <div className="flex items-center space-x-2 mt-3 text-xs text-[var(--text-muted)]">
