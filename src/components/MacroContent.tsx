...
import MacroSearchFilter from './MacroSearchFilter'
...
export default function MacroContent({ episodes, videos, userRole, userTier }: MacroContentProps) {
        ...
        <div className="mt-16">
          <div className="text-center mb-8">
            <h2 className="heading-two-tone text-3xl mb-2">
              <span>Macro</span> <span className="gold">Videos</span>
            </h2>
