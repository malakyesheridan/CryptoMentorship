...
export function StreakWidget({ 
  ...
  return (
    <Card className={cn('bg-gradient-to-r from-[#2a2018] to-[#2e1a1a] border-[#2a2018] group-hover:shadow-xl group-hover:scale-[1.02] group-hover:-translate-y-1 transition-all duration-300 transform-gpu', className)}>
      <CardContent className="p-6">
        <div className="flex items-start justify-between mb-4 group-hover:scale-105 transition-transform duration-300">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-[var(--text-strong)] group-hover:text-orange-700 transition-colors duration-300">Learning Streak</h3>
          ...
          <div className="text-right group-hover:scale-105 transition-transform duration-300">
            <div className="flex items-center gap-1 text-sm text-[var(--text-strong)] mb-1 group-hover:text-[var(--text-strong)] transition-colors duration-300">
              <Target className="h-4 w-4 group-hover:scale-110 transition-transform duration-300" />
              <span>Total Lessons</span>
            </div>
            <div className="text-lg font-semibold text-[var(--text-strong)] group-hover:text-orange-700 transition-colors duration-300">
              {totalLessonsCompleted}
            </div>
          </div>
        </div>

        <p className="text-[var(--text-strong)] mb-4 group-hover:text-[var(--text-strong)] transition-colors duration-300">
        ...
        {nextMilestone && (
          <div className="mb-4 group-hover:scale-105 transition-transform duration-300">
            <div className="flex items-center justify-between text-sm text-[var(--text-strong)] mb-2 group-hover:text-[var(--text-strong)] transition-colors duration-300">
